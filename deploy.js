...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    ...
    '/home/ubuntu/deployment-handson-two',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf deployment-handson-two && mkdir deployment-handson-two', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir deployment-handson-two && cp -r deployment-handson-two/* deployment-handson-two/ && rm -rf deployment-handson-two', {
      cwd: '/home/ubuntu'
  });
}
